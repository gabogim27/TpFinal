...
BEGIN
	...
	IdDomicilio int not null references DOMICILIO,--CAMBIAR EL TIPO DE DATO EN EL DOC
...
BEGIN
	...
	IdCobertura INT NOT NULL REFERENCES COBERTURA,
	--IdPoliza INT NOT NULL REFERENCES POLIZA,//ELIMINAR ESTE CAMPO DEL DOCUMENTO
	IdVehiculo INT NOT NULL REFERENCES VEHICULO,
...
BEGIN
	...
	IdDetalle INT NOT NULL REFERENCES DETALLE_POLIZA,
...
BEGIN
	...
	Estado BIT NOT NULL,
	IdTipoPoliza INT NOT NULL REFERENCES POLIZA,
...
BEGIN
	...
	(
	IdDetalle INT NOT NULL,
	IdPoliza INT NOT NULL REFERENCES POLIZA,
	IdVehiculo INT NOT NULL REFERENCES Vehiculo,
	IdCliente INT NOT NULL REFERENCES CLIENTE,
	IdContacto INT NOT NULL REFERENCES CONTACTO,
...
/****** Object:  Table [dbo].[TipoVehiculo]    Script Date: 9/16/2018 3:33:11 PM ******/
SET ANSI_NULLS ON
GO
